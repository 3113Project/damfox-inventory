...
blocked_tasks:
  - task: TASK-0028
    reason: Richiede REVIEW-0027 approvata.
  - task: TASK-0029
...
- TASK-0027 crea il progetto frontend e l'integrazione runtime.
- TASK-0028 produce il primo app shell visibile e responsivo.
